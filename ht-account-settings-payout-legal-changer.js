...
class HTAccountSettingsPayoutLegalChanger extends LitElement {
  render() {
...
`;
  ...
  static get is() {
    return "ht-account-settings-payout-legal-changer";
  }
  ...
  _change(legalType) {
    this.dispatchEvent(
      new CustomEvent("on-payout-legal-changed", {
        bubbles: true,
        composed: true,
        detail: legalType
      })
...
customElements.define(
  HTAccountSettingsPayoutLegalChanger.is,
  HTAccountSettingsPayoutLegalChanger
);
